...
from model_definition._utils import overwrite_eps
from torchvision._internally_replaced_utils import load_state_dict_from_url

from model_definition.anchor_utils import AnchorGenerator
from model_definition.generalized_rcnn import GeneralizedRCNN
from model_definition.rpn import RPNHead, RegionProposalNetwork
from model_definition.roi_heads import RoIHeads
from model_definition.transform import GeneralizedRCNNTransform
from model_definition.backbone_utils import resnet_fpn_backbone, _validate_trainable_layers, mobilenet_backbone
...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 bbox_reg_weights=None, classification_loss_function=F.cross_entropy, class_weights=None):
        ...
        roi_heads = RoIHeads(
            ...
            bbox_reg_weights,
            box_score_thresh, box_nms_thresh, box_detections_per_img, classification_loss_function, class_weights)
